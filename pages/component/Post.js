    ...
    <div className="post">
      <div className="postWrapper">
        ...
        <div className="postCenter">
          <span className="postText text-light text-light-1">When scraping body text, we automatically remove any scripts, styles,</span>
        ...
        <div className="postBottom">
          <div className="postBottomLeft">
            ...
            <img
              ...
              alt=""
            />
            <span className="postLikeCounter text-light-1">like people like it</span>
          </div>
