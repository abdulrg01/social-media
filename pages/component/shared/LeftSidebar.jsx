...
export default function LeftSidebar() {
  ...
  return (
    <div className="custom-scrollbar leftsidebar">
      <div class="border border-gray-200 bg-gray-50 dark:bg-gray-950 dark:border-gray-600 text-sm text-gray-500rounded-lg shadow-sm w-full dark:text-gray-400">
        <div class="p-3">
          <div class="flex">
            <div class="me-3 shrink-0">
              <Link
                href="/"
                class="block p-2 bg-gray-100 rounded-lg dark:bg-gray-900"
              >
                <img
            ...
            <div>
              ...
              <p class="mb-3 text-sm font-normal">{user.bio}</p>
              ...
              {toggle && (
                <div class="z-10  absolute top-32 right-5 bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-900">
