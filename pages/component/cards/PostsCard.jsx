...
export default function PostsCard({
  ...
  const [followUnFollowUser, setFollowUnFollowUser] = useState(false);

  return (
    <article
      className={`flex w-full flex-col rounded-xl mt-5 border border-gray-200 bg-gray-50 dark:bg-gray-950 dark:border-gray-600 ${
        isComment ? "px-2 xs:px-2 py-5" : "bg-dark-2 pb-7 pt-1"
      }`}
    >
      ...
      <div className="flex flex-col">
        <div className={`${isComment ? "px-0 xs:px-7" : "p-5"}`}>
          <div className="flex items-start justify-between relative">
            ...
            >
              <img
                src={author ? author?.profilePic : "/user.svg"}
                alt="profile image"
                  ...
                  {!followingPosts && (
                    <li>
                      <a
                        ...
                        // onClick={() => handleFollowUnFollowUser(data?._id)}
                        onClick={() => setFollowUnFollowUser(true)}
                      >
                        <svg
                  ...
                  {followingPosts && (
                    <li>
                      <a
                        ...
                        class="flex items-center flex-nowrap cursor-pointer py-2 px-4 text-sm hover:bg-gray-100 dark:hover:bg-gray-800 dark:hover:text-white"
                        // onClick={() => handleFollowUnFollowUser(data?._id)}
                        onClick={() => setFollowUnFollowUser(false)}
                      >
                        <svg
                          class="mr-2 w-4 h-4 text-gray-400"
                          aria-hidden="true"
